...
def compute(createSurfaces=True):
    ...
    if createSurfaces:
        ...
        fv2 = Surface() ;
        fv2.Isosurface(I1, value = 0, target=2000, scales=[1, 1, 1], smooth=0.1)
    ...
    sm = SurfaceMatchingParam(timeStep=0.1, sigmaKernel=20, sigmaDist=20, sigmaError=1., errorType='current')
    f = SurfaceMatching(Template=fv1, Target=fv2, outputDir='/Users/younes/Development/Results/Diffeons2/Scale1',param=sm, testGradient=False, DiffeonEpsForNet = r0,
                        ...
                        maxIter=250, affine='none', rotWeight=1., transWeight = 1., scaleWeight=10., affineWeight=100., zeroVar=False)
