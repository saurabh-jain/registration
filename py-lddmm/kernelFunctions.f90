...
subroutine applyk2(x, y, beta, sig, ord, num_nodes, num_nodes_y, dim, dimb, f)
  implicit none
  integer :: num_nodes, num_nodes_y, dim, dimb
  real(8) :: x(num_nodes, dim)
  real(8) :: y(num_nodes_y, dim)
  ...
  !$omp end parallel do
end subroutine applyK2

subroutine applykdiff2(x, y, beta, sig, ord, num_nodes, num_nodes_y, dim, f)
  implicit none
