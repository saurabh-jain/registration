...
def compute():
    ...
    ## Object kernel
    K1 = Kernel(name='gauss', sigma = 1.)
    ## Background kernel
    K2 = Kernel(name='gauss', sigma = 0.2)

    sm = CurveMatchingParam(timeStep=0.1, KparDiff=K1, KparDiffOut=K2, sigmaDist=0.5, sigmaError=.01, errorType='current')
    f = (CurveMatching(Template=(fv1,fv2), Target=(fv3,fv4), outputDir='/Users/younes/Development/py-lddmm/Results/Curves_Sliding',param=sm, mu=.001,regWeightOut=1., testGradient=False,
