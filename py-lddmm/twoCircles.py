...
def compute():
    ...
    f = (CurveMatching(Template=(fv1,fv2), Target=(fv3,fv4), outputDir='Results/Curves_Sliding',param=sm, mu=1.,regWeightOut=1., testGradient=False,
                       typeConstraint='sliding', maxIter_cg=1000, maxIter_al=100, affine='none', rotWeight=10))
    f.optimizeMatching()
